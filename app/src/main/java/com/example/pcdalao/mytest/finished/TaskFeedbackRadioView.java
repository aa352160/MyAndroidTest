...
public class TaskFeedbackRadioView extends LinearLayout {
    private Context mContext;
    private List datas;
    private String selectData="";
    private List<View> viewList;

    public TaskFeedbackRadioView(Context context) {
        this(context,null);
    }

    public TaskFeedbackRadioView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext=context;
    ...
    private void initView() {
        ...
        for (int i = 0; i < datas.size(); i++) {
            ...
            LinearLayout.LayoutParams imageLp = new LinearLayout.LayoutParams(dp2px(22),dp2px(22));
            imageLp.setMargins(0,0,dp2px(5),0);
